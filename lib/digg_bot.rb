...
bot.plugin("digg top stories") do |m|
  m.answer  digger.top_stories || "No results found"
end

bot.plugin("digg containers") do |m|
  m.answer digger.containers || "No results found"
end

bot.plugin("digg hot stories in :container") do |m|
  m.answer digger.hot_stories_from(m.args[:container]) || "No results found"
end
